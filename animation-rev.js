		...
		if (status === 'OK') {
			...
			directionsService.route(request, function(result, status) {
				if (status == google.maps.DirectionsStatus.OK) {
					...
					result_details.innerHTML = "<div data-w-id=\"af6a265f-5d07-8ee6-961c-2794bb2d18b6\" class=\"shipper-result-details text-body text-left margin-top-15\">Total Distance: " + round(d/1.60934,1) + " mi<br><br>" + "Low cost/mile: $" + round(low_cost_mile,2) + "<br>High cost/mile: $" + round(high_cost_mile,2) + "</div>"
